...
int main()
{
    ...
    printf("\n\n Instructions for playing this Quiz game ");
    printf("\n -------------------------------------------------------------------------");
    ...
    printf("\n    total of 10 questions. Each right answer will be awarded RS.1,00,000!");
    ...
    system("cls");
     ...
     switch(r1)
		{
		case 1:
		printf("\n\nWhich of the following Malayalam film nominated for Oscar recently ?");
		printf("\n\nA.Forensic\t\tB.Pullar\n\nC.Jallikattu\t\tD.Juliet");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;
			    getch();
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.Jallikattu");
		           getch();
		       break;
		       }

        case 2:
		printf("\n\n\nWho was elected as the Vice president of USA in 2020 ?");
		printf("\n\nA.Kamala Harris\t\tB.Bill Philips \n\nC.Mary queens\t\tMike troult");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Kamala Harris");
		       getch();
		       break;}

        case 3:
		printf("\n\n\nWhen is Indian Flag celebrated ?");
		printf("\n\nA.DEC 4\t\tB.DEC 5\n\nC.DEC 6\t\tD.DEC 7");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		       ...
		       {
                         printf("\n\nWrong!!! The correct answer is D.DEC 7");
		         getch();
		         break;
                       }
		...
		printf("\n\nA.Sanjay Khalia\t\tB.Shakthi Kanta Dass\n\nC.Urjith singh patel \t\tD.Johnson david ");
		if (toupper(getch())=='B')
			{
                        printf("\n\nCorrect!!!");count++;
			getch();
			 break;
		       ...
		       {
                       printf("\n\nWrong!!! The correct answer is B.Shakthi Kanta Dass");
		       getch();
		       break;
                       }
        ...
        case 6:
		printf("\n\n\nWhich state is awarded as ''THE BEST STATE IN 202'' BY TIMES OF INDIA ?");
		...
		if (toupper(getch())=='D' )
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is D.Tamil Nadu ");
		       getch();
		       break;}}
		       }
	...
	{
	system("cls");
        printf("\n\nYOU DIDN'T PASSED IN WARMUP ROUND");
...
game:
     ...
     switch(r)
        ...
        case 4:
		printf("\n\n\nWhen was the first FIVE YEARS PLAN introduced ?");
		printf("\n\nA.1950\t\tB.1955\n\nC.1953\t\tD.1952");
		if (toupper(getch())=='A')
			{
                        printf("\n\nCorrect!!!");
			 ...
			 break;
		       ...
		       {
                       printf("\n\nWrong!!! The correct answer is A.1950");
                       getch();
		       goto score;
		       break;
		       }
        ...
        case 5:
		printf("\n\n\nWhich is the longest flowing river in south India ");
		printf("\n\nA.Cauvery\t\tB.Godavari\n\nC.Krishna\t\tD.Narmadha");
		if (toupper(getch())=='B')
			{
                        printf("\n\nCorrect!!!");
                        countr++;
		       ...
		       {
		       printf("\n\nWrong!!! The correct answer is B.Godavri");
		       getch();
		       goto score;
		       break;
		       }
		...
		case 18:
		printf("\n\n\nWho developed the c program ?");
		printf("\n\nA.Bjarne stroustrap\t\tB.Guido van russum \n\nC.Mark elenbourgh\t\tD.Dennis Richie\n\n");
		if (toupper(getch())=='D')
			{
                        printf("\n\nCorrect!!!");
                        countr++; 
			...
			break;
		       ...
		       {
                       printf("\n\nWrong!!! The correct answer is D.Dennis Richie");
                       getch();
                       goto score;
		       break;
                       }
		...
		case 22:
		printf("\n\n\nWhich NBA basket ball star played died recently in accident ?");
		printf("\n\nA.Stephen curry\t\tB.Martin louis\n\nC.Bid houston\t\tD.Kobe Bryant");
		if (toupper(getch())=='D')
			{
                         printf("\n\nCorrect!!!");
                         countr++; 
	...
	if(score>0.00 && score<1000000.00)
	{
	   printf("\n\n\t\t**************** CONGRATULATION *****************");
	 ...
	 else if(score==1000000.00)
	{
	    ...
	    printf("\n\t\t You won Rs.%.2f",score);
	    printf("\t\t Thank You for playing this QUIZ GAME !!");
	}
	 else
        {
